...
//TODO: use the airtame-discovery-sdk instead
...
void print_cmdline_help() {
    printf("\n Commands:\n"
            ...
            " a/audio <on/off>         : Enable/Disable audio\n"
...
int parse_cmdline(char *line) {
    ...
    // TODO: improve this and abstract the commands away from here
...
void read_cmdline(void *data) {
    // create the and register the state listener
